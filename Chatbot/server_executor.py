        ...
        if so_ban_con_lai >= so_ban:
            if updateStatus:
                ...
                insert_params = (
                    ...
                    reservation_date, 'Confirmed', so_nguoi, note
                )
...
def main():
    ...
    user_input = "đặt bàn 2 người 19 giờ ngày 12 tháng 10" #đặtbàn
    #user_input = "gọi 1 bánh mì, 1 phở bò" #gọi món
    #user_input = "gợi ý món ăn tráng miệng" #giá dưới 35000 đồng" #gợi ý món ăn 
    topic, entities, miss_info = tnm(model_path,user_input)
